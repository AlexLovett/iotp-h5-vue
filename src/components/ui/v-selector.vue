...
<template>
  <div>
    <a data-v-7db7761a="" class="mint-cell mint-field ripple" v-on:click="isShow = true">
      ...
      <div class="mint-cell-wrapper">
        ...
        <div class="mint-cell-value">
          <input :placeholder="placeholder" type="text" class="mint-field-core" :value="selectedLabel" readonly>
